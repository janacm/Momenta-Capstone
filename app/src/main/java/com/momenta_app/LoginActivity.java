...
//            showProgressDialog();
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) { //Sign in successful
    ...
    private void signIn() {
        Intent signInIntent = Auth.GoogleSignInApi.getSignInIntent(sm.getGoogleApiClient());
    ...
    /**
     * Checks on and updates Google Play services if necessary.
     * @return true asserting GooglePlayServices is installed and up to date.
     */
